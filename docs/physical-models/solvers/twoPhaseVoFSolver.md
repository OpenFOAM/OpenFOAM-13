...
- **源码头文件**: [`applications/modules/twoPhaseVoFSolver/twoPhaseVoFSolver.H`](../../../applications/modules/twoPhaseVoFSolver/twoPhaseVoFSolver.H)
- **链接库 (Make/options)**: `twoPhaseSolver`, `physicalProperties`, `interfaceCompression`, `interfaceProperties`, `twoPhaseMixture`, `finiteVolume`, `meshTools`, `fvModels`, `fvConstraints`, `sampling`
...
- **角色**: 两相 VoF 基类
- **物理包**: 由 `incompressibleVoF` / `compressibleVoF` 等决定
...
- [`applications/modules/twoPhaseVoFSolver/Make/options`](../../../applications/modules/twoPhaseVoFSolver/Make/options)
