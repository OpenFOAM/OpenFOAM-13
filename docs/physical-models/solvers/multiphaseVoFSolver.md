...
- **源码头文件**: [`applications/modules/multiphaseVoFSolver/multiphaseVoFSolver.H`](../../../applications/modules/multiphaseVoFSolver/multiphaseVoFSolver.H)
- **链接库 (Make/options)**: `VoFSolver`, `fluidSolver`, `physicalProperties`, `multiphaseProperties`, `interfaceCompression`, `finiteVolume`, `meshTools`, `fvModels`, `fvConstraints`, `sampling`
...
- [`applications/modules/multiphaseVoFSolver/Make/options`](../../../applications/modules/multiphaseVoFSolver/Make/options)
