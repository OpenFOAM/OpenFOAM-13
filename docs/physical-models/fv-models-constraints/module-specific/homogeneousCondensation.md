...
- 源码：[`applications/modules/multiphaseEuler/fvModels/homogeneousCondensation/homogeneousCondensation.H`](../../../../applications/modules/multiphaseEuler/fvModels/homogeneousCondensation/homogeneousCondensation.H)
- 实现：同目录 `.C`
