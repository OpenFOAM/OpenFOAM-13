...
适用: incompressibleVoF / compressibleVoF
...
- 源码：[`applications/modules/incompressibleVoF/fvModels/VoFTurbulenceDamping/VoFTurbulenceDamping.H`](../../../../applications/modules/incompressibleVoF/fvModels/VoFTurbulenceDamping/VoFTurbulenceDamping.H)
- 实现：同目录 `.C`
