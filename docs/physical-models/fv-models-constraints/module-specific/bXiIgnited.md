...
```c++
// `tutorials/XiFluid/1D/constant/fvModels`
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //
...
- 源码：[`applications/modules/XiFluid/fvModels/ignition/bXiIgnited/bXiIgnited.H`](../../../../applications/modules/XiFluid/fvModels/ignition/bXiIgnited/bXiIgnited.H)
- 实现：同目录 `.C`
