...
- **注册名**: `wakeEntrainmentCoalescence`
...
- 注册名 / `type`: `wakeEntrainmentCoalescence`
- 基类: `IATEsource`
...
## 文献与源码依据
- 类: `Foam`::diameterModels::IATEsources::wakeEntrainmentCoalescence`
...
## 注意事项
- 类型名必须与 RTS 注册名一致：`wakeEntrainmentCoalescence`。
