...
motionSolver    sixDoFRigidBodyMotionSolver;
...
- 源码：[`src/rigidBodyMotion/sixDoFRigidBodyMotion/sixDoFRigidBodyMotionSolver/sixDoFRigidBodyMotionSolver.H`](../../../../src/rigidBodyMotion/sixDoFRigidBodyMotion/sixDoFRigidBodyMotionSolver/sixDoFRigidBodyMotionSolver.H)
- 实现：同目录 `.C`
