# `kineticTheoryViscosity`-HrenyaSinclair`

## 一句话

颗粒动力学理论粘度子模型 `HrenyaSinclair`
...
动力学理论颗粒粘度子模型 `type` HrenyaSinclair`。


## 文献与源码依据

- [`applications/modules/multiphaseEuler/momentumTransportModels/kineticTheoryModels/viscosityModel/HrenyaSinclair/HrenyaSinclairViscosity.H`](../../../applications/modules/multiphaseEuler/momentumTransportModels/kineticTheoryModels/viscosityModel/HrenyaSinclair/HrenyaSinclairViscosity.H)
