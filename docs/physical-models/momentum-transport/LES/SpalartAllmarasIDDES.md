...
- [`src/MomentumTransportModels/momentumTransportModels/LES/SpalartAllmarasIDDES/SpalartAllmarasIDDES.H`](../../../src/MomentumTransportModels/momentumTransportModels/LES/SpalartAllmarasIDDES/SpalartAllmarasIDDES.H)

## 教程与模板

- 仓库 tutorials 中未检索到 `SpalartAllmarasIDDES` 字面配置；可参考同类 `simulationType` 案例并改 `model`。
