...
预置液体物性库条目 `MB`（`liquidProperties` RTS）。
...
- [`src/thermophysicalModels/thermophysicalProperties/liquidProperties/MB/MB.H`](../../../src/thermophysicalModels/thermophysicalProperties/liquidProperties/MB/MB.H)
