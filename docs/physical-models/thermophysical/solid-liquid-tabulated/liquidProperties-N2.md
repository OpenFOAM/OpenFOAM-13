...
预置液体物性库条目 `N2`（`liquidProperties` RTS）。
...
- [`src/thermophysicalModels/thermophysicalProperties/liquidProperties/N2/N2.H`](../../../src/thermophysicalModels/thermophysicalProperties/liquidProperties/N2/N2.H)
