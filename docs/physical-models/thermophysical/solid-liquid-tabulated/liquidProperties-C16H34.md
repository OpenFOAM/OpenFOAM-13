...
预置液体物性库条目 `C16H34`（`liquidProperties` RTS）。
...
- [`src/thermophysicalModels/thermophysicalProperties/liquidProperties/C16H34/C16H34.H`](../../../src/thermophysicalModels/thermophysicalProperties/liquidProperties/C16H34/C16H34.H)
