...
预置液体物性库条目 `C2H6`（`liquidProperties` RTS）。
...
- [`src/thermophysicalModels/thermophysicalProperties/liquidProperties/C2H6/C2H6.H`](../../../src/thermophysicalModels/thermophysicalProperties/liquidProperties/C2H6/C2H6.H)
