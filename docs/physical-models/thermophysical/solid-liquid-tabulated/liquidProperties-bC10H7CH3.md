...
预置液体物性库条目 `bC10H7CH3`（`liquidProperties` RTS）。
...
- [`src/thermophysicalModels/thermophysicalProperties/liquidProperties/bC10H7CH3/bC10H7CH3.H`](../../../src/thermophysicalModels/thermophysicalProperties/liquidProperties/bC10H7CH3/bC10H7CH3.H)
