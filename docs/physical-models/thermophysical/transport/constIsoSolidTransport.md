...
- `thermoType`.transport` ≈ `constIso`（类 `constIsoSolidTransport`）
...
- 源码：[`src/thermophysicalModels/solidThermo/solidSpecie/transport/constIso/constIsoSolidTransport.H`](../../../src/thermophysicalModels/solidThermo/solidSpecie/transport/constIso/constIsoSolidTransport.H)
