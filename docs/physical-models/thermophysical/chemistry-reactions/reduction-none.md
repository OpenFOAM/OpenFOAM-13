...
noChemistryReduction：不删减机理。

## 文献与源码依据

- [`src/thermophysicalModels/chemistryModel/chemistryModel/reduction/noChemistryReduction/noChemistryReduction.H`](../../../src/thermophysicalModels/chemistryModel/chemistryModel/reduction/noChemistryReduction/noChemistryReduction.H)
