...
DRG with Error Propagation chemistry reduction（见源码头文件）。

## 文献与源码依据

- [`src/thermophysicalModels/chemistryModel/chemistryModel/reduction/DRGEP/DRGEP.H`](../../../src/thermophysicalModels/chemistryModel/chemistryModel/reduction/DRGEP/DRGEP.H)
