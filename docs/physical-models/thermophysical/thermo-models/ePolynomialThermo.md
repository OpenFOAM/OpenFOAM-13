...
- `thermoType`.thermo` 字典值常用：`ePolynomial`（对应类 `ePolynomialThermo`）
...
- 源码：[`src/thermophysicalModels/specie/thermo/ePolynomial/ePolynomialThermo.H`](../../../src/thermophysicalModels/specie/thermo/ePolynomial/ePolynomialThermo.H)
