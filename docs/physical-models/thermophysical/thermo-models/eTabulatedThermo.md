...
- `thermoType`.thermo` 字典值常用：`eTabulated`（对应类 `eTabulatedThermo`）
...
- 源码：[`src/thermophysicalModels/specie/thermo/eTabulated/eTabulatedThermo.H`](../../../src/thermophysicalModels/specie/thermo/eTabulated/eTabulatedThermo.H)
